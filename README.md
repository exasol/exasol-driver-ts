...
4. Supports importing local CSV and Parquet files into a table from Node.js (Parquet requires Exasol 2026.1 or later)

## Information for Users

- [User Guide](doc/user_guide/user_guide.md)
- [API Reference](https://exasol.github.io/exasol-driver-ts/api/)
- [Traceability Report](https://exasol.github.io/exasol-driver-ts/trace/)
